...
output_folder = "dataset/augmentedDatasetDikshit/noiseimages"
...
# artifact_probability = 0.3  # Probability of adding artifacts
...
for filename in os.listdir(input_folder):
    if filename.endswith(".jpg") or filename.endswith(".png"):
        ...
        #     num_artifacts = np.random.randint(1, 6)  # Number of artifacts to add
